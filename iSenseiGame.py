...
def switchAi(module1, module2):
    ai_player_1 = importlib.import_module(module1, package = None)
    ai_player_2 = importlib.import_module(module2, package = None)
    return (ai_player_1 , ai_player_2)
#ai_player_1 , ai_player_2 = switchAi("terminator_copy","terminator")
...
class iSensei(object):
    def __init__(self,module1,module2):
        ...
        self.playing = False
        self.ai_player_1 = importlib.import_module(module1, package = None)
        self.ai_player_2 = importlib.import_module(module2, package = None)
    ...
    def play(self):
        ...
        if len(availables) > 0:
            [r,c] = self.ai_player_1.play(self.board, availables,1) if self.player else self.ai_player_2.play(self.board, availables,2) 
        ...
        try :
            ...
            while True:
                ...
                if self.check_win(self.lastPosition, self.player):
                    print (self.ai_player_1.name if self.player else self.ai_player_2.name,
    ...
    def __call__(self,module1,module2):
        self.ai_player_1 = importlib.import_module(module1, package = None)
        self.ai_player_2 = importlib.import_module(module2, package = None)
        self.execute()
        return self
